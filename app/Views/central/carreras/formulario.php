                ...
                <form name="forEstadoCarrera" id="forEstadoCarrera">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <button type="button" onclick="estadoCarrera(1)" class="btn btn-outline-primary">Negativa</button>
                            <button type="button" onclick="estadoCarrera(2)" class="btn btn-outline-secondary">Cancelada</button>
                            <button type="button" onclick="estadoCarrera(3)" class="btn btn-outline-success">Perdida</button>
                        </div>
                    </div>
                </form>
